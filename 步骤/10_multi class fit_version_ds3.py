...
label0 = torch.zeros(691)
label1 = torch.ones(488)
label2 = torch.ones(300)
label2 *= 2

label3 = torch.zeros(150)
label4 = torch.ones(150)
label5 = torch.ones(100)
label5 *= 2
...
df1 = pd.read_excel('ds3/train/第一类_train.xlsx',sheet_name='Sheet1')
df2 = pd.read_excel('ds3/train/第二类_train.xlsx',sheet_name='Sheet1')
df3 = pd.read_excel('ds3/train/第三类_polyfit_train.xlsx',sheet_name='Sheet1')
#测试集
df4 = pd.read_excel('ds3/test/第一类_test.xlsx',sheet_name='Sheet1')
df5 = pd.read_excel('ds3/test/第二类_test.xlsx',sheet_name='Sheet1')
df6 = pd.read_excel('ds3/test/第三类_polyfit_test.xlsx',sheet_name='Sheet1')
...
def draw_train(output):
    ...
    accuracy = sum(pred_y == target_y)/1479
